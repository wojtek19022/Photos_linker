...
SOURCES = \
	__init__.py \
	photo_link.py photo_link_dialog.py

PLUGINNAME = photo_link

PY_FILES = \
	__init__.py \
	photo_link.py photo_link_dialog.py

UI_FILES = photo_link_dialog_base.ui
...
QGISDIR=C:\Users\wojta\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
